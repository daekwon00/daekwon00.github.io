...
const skillIcons: Record<string, React.ComponentType<IconProps>> = {
  brain: BrainIcon,
  code: CodeIcon,
  cloud: CloudIcon,
  globe: GlobeIcon,
...
export function getSkillIcon(key: string): React.ComponentType<IconProps> {
  return skillIcons[key] ?? BrainIcon;
}
